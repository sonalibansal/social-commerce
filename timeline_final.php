  		...
  		<div class="container-fluid">
  			...
  			<div class="navbar-collapse collapse">
  				<ul class="nav navbar-nav navbar-right">
                    <li class="" ><a href="home_final.php"><i class="fa fa-home" aria-hidden="true"></i> Home </a></li>
  					<li class="active" ><a href="timeline.php"><i class="fa fa-user" aria-hidden="true"></i> Timeline </a></li>
...
<input type="checkbox" name="check_list[]" value="Mobiles and Accessories">Mobiles and Accessories<br/>
<input type="checkbox" name="check_list[]" value="Clothing">Clothing<br/>
<input type="checkbox" name="check_list[]" value="Books">Books<br/>
<input type="checkbox" name="check_list[]" value="Gifts">Gifts<br/>
 <input type="checkbox" name="check_list[]" value="Foot wear">Foot wear<br/>
<input type="checkbox" name="check_list[]" value="Accessories">Accessories<br/>
<input type="submit" />
</form>
                </div>
